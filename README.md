...
Uma lista com as bandeiras dos países mostrando o total da população referente ao país onde se pode filtrar pelo nome.

## Instalação

Abra o terminal e digite:

### `git clone  https://github.com/heyv/React-Countries.git`
